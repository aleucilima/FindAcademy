...
import mapMarkerIcon from '../images/mapmarker.png';

import '../styles/pages/academy.css';

const academyMapIcon = L.icon({
...
export default function Academy() {
  ...
  return (
    <div id="page-academy">
      <aside>
        <img src={mapMarkerIcon} alt="Academy" />
          ...
          <div className="academy-details-content">
            ...
            <div className="map-container">
              ...
              >
                ...
                />
                <Marker interactive={false} icon={academyMapIcon} position={[-27.2092052,-49.6401092]} />
              </Map>
